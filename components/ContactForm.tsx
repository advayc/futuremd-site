                ...
                <div className="flex justify-center">
                    <div className="flex flex-row w-5/6 mt-4 space-x-4">
                        <div className="flex flex-col w-1/2">
                            ...
                            <input
                                id="firstName"
                                className={`dark:text-white text-black w-full outline-0 mb-4 h-12 bg-gray-200 rounded-lg p-3 dark:bg-[#191919] border-2 ${inputClasses(!firstName, isFirstNameTouched)}`}
                                type="text"
                                value={firstName}
                                onChange={(e) => {
                        ...
                        <div className="flex flex-col w-1/2">
                            ...
                            <input
                                id="lastName"
                                className={`dark:text-white text-black w-full outline-0 mb-4 h-12 bg-gray-200 rounded-lg p-3 dark:bg-[#191919] border-2 ${inputClasses(!lastName, isLastNameTouched)}`}
                                type="text"
                                value={lastName}
                                onChange={(e) => {
