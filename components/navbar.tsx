...
return (
    <header className="flex justify-between items-center">
        <a href="/"><img src="logo.png" alt="Logo" className="h-[50px]"/></a>
        <nav className="flex items-center">
            ...
            <a href="/contact" className="bg-[#28387D] text-white px-5 py-3 rounded-[10px] font-bold mr-10 hover:opacity-80 transition duration-300">Contact Us</a>
        </nav>
    </header>
);
};
