export const roles = [
    {
      title: "Marketing",
      description: `
        As marketing members, your mission is to promote the organization to the best of your ability. This includes (but is not limited to) in-person, online, or content creation on different social media platforms.<br><br>
        <strong>Responsibilities:</strong><br>
        - Managing social media<br>
        - Promoting organization & events in-person and online<br>
        - Developing ideas for social media posts and videos<br>
