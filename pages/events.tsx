    ...
    <main className={`min-h-screen items-center justify-between pt-8 ${inter.className} dark:bg-dark-bg bg-light-bg transition-colors duration-700`}>
      ...
      <section className="px-4 max-w-9xl mx-auto md:ml-20 md:mt-20 mt-10">
        ...
        <div className="flex justify-start mb-20">
          <a href='/path2med'>
          <Card className="transition-transform duration-300 transform hover:scale-105 bg-transparent dark:bg-dprimary border border-zinc-300 hover:border-zinc-400 dark:border-transparent dark:hover:border-zinc-300 dark:hover:border-zinc-800 max-w-md rounded-lg p-2 mt-6">
