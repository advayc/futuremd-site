...
export default function Contact() {
  return (
    <main className={`min-h-screen flex flex-col items-center justify-between py-8 ${inter.className} bg-black light:bg-light-bg`}>
      <Navbar />
      <div className="py-8 px-4 w-full max-w-9xl">
        ...
        <p className="text-center mb-4 text-lg md:text-2xl font-bold text-dark-text light:text-gray-600">
          If you have a question or business inquiry, <br />feel free to contact us here to get a quick response!
        </p>
        <ContactForm />
        <div className="flex flex-col items-center mt-6">
          <h2 className="text-3xl md:text-4xl font-bold mb-4 text-white light:text-black">Connect With Us</h2>
