  ...
  return (
    <main className={`flex flex-col items-center justify-center pt-8  dark:bg-dark-bg bg-light-bg transition-colors duration-700`}>
      ...
      <svg width="1916" height="230" viewBox="0 0 1916 230" fill="currentColor" className="rotate-180 w-full h-auto text-primary dark:text-dprimary ">
        ...
        <div className="w-full flex flex-col md:flex-row items-center justify-center bg-primary dark:bg-dprimary px-8 sm:px-16 md:px-36 pb-14">
        ...
        <div className="w-full flex flex-col md:flex-row items-center justify-center shadow hover:shadow-lg mt-22 px-8 sm:px-16 md:px-24 pt-10 pb-12 md:pb-28 mt-10">
