    ...
    <main className={`flex flex-col items-center justify-center pt-8 ${inter.className} dark:bg-dark-bg bg-light-bg transition-colors duration-700`}>
      ...
      <div className="w-full flex flex-col items-center dark:bg-dprimary bg-primary pt-16 pb-12" id="what-does">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 w-full px-4 md:px-48">
          ...
          <div className="flex flex-col items-center mb-4 transition-transform duration-300 transform hover:scale-105">
            <div className="w-64 h-40 overflow-hidden">
              <img src="public/guest speakers.jpg" alt="Guest Speakers" className="object-cover w-full h-full" />
            </div>
      ...
      <div ref={(el) => { if (el) fadeRefs.current[2] = el; }} className="fade-in w-full flex flex-col w-full max-w-6xl py-20" id="vision">
