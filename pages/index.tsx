...
export default function Home() {
  ...
  return (
    <main className={`flex flex-col items-center justify-center pt-8 ${inter.className} dark:bg-dark-bg bg-light-bg transition-colors duration-700`}>
      ...
      <div id="vision" className="w-full flex flex-col w-full max-w-6xl py-20">
        <div className="flex flex-col md:flex-row items-center w-full px-4">
        <div className="md:w-1/2 text-center md:text-left">
            <h2 className="text-7xl font-bold dark:text-white text-black mb-4">Our Vision</h2>
          </div>
          <div className="text-lg sm:text-xl md:text-2xl text-center md:text-left max-w-2xl text-[#828282] font-bold">
      ...
      <div id="abt" className="w-full flex flex-col items-center dark:bg-dprimary bg-primary pt-6 pb-12">
